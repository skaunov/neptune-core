...
/// note: we `serde(skip)` fields that can be computed from the seed in order to keep the serialized (including bech32m) representation small
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for FieldVisitor {
                ...
                V: serde::de::SeqAccess<'de>,
            {
                ...
                Ok(PokolenSpendingKey::derive_from_seed(seed))
            }
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(PokolenSpendingKey::derive_from_seed(seed_digest))
            }
        }
